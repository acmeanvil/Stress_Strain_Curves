...
with st.sidebar:
    ...
    with tab1:
        st.markdown("<h2 style='text-align: center; color: Gray;'>Upload File or Use Current Sample</h2>", unsafe_allow_html=True)
        try: 
            ...
            pass
        st.markdown("<h2 style='text-align: center; color: Gray;'>Data Import Format Template</h2>", unsafe_allow_html=True)
